...
$routes->post('buscar_DepartamentosPais/(:num)', 'Departamentos::buscar_DepartamentosPais/$1');
$routes->post('buscar_MunicipioDepartamento/(:num)', 'Municipios::buscar_MunicipioDepartamento/$1');
