...
<body>
  <div class="container-lg">
    ...
    <div class="botones align-baseline">
        <button type="button" class="btn agregar" data-bs-toggle="modal" data-bs-target="#cargosModal_agregar" onclick="seleccionaCargo(<?php echo 1 . ',' . 1 ?>);" >Agregar</button>
          ...
          <tbody style="font-family:Arial;font-size:12px;text-align: center;">
            <?php foreach ($cargos as $dato) { ?>
              <tr>
                ...
                <td style="width: 70px;"><button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#cargosModal_agregar" class="btn btn-light" onclick="seleccionaCargo(<?php echo $dato['id'] . ',' . 2 ?>);"><i class="bi bi-pencil-square"></i></button></td>
                <td style="width: 70px;"><button type="button" class="btn btn-light" data-href="<?php echo base_url('/cargos/eliminar') . '/' .$dato['id']. '/' .'E'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma" ><i class="bi bi-trash3"></i></button></td>                
              </tr>
            <?php }?>
          </tbody>
        </table>
    ...
    <form method="POST" action="<?php echo base_url('/Cargos/insertar'); ?>" autocomplete="off">
      <div class="modal fade" id="cargosModal_agregar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="cargosModal_agregar">Agregar Cargo</h1>
