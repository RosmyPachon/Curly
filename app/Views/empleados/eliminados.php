...
<div class="container-lg">
    <h1 class="titulo" style="color: #93623c;text-align: center;">Empleados Eliminados</h1>
    <div class="botones align-baseline" style=" margin: 30px 6px;height: 60px;">
        <a style="border-color: none;color: white;background-color: #93623c;" href="<?php echo base_url('/empleados'); ?>"  class="btn  regresar_Btn">Regresar</a>
    </div>
    <div class="table-responsive">
      <table class="table table-bordered table-sm table-striped shadow p-3 mb-5 bg-body-tertiary rounded" id="dataTable" width="100%" cellspacing="0">
		...
		<td><?php echo $dato ['id'];?></td>
                ...
                <td style="width: 70px;"><button type="button" class="btn btn-light" data-href="<?php echo base_url('/empleados/eliminar') . '/' .$dato['id']. '/' .'A'; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma"><i class="bi bi-arrow-repeat"></i></button></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
...
<script>
  ...
  function eliminarEmpleados(id) {     
      $("#id").val(id);
      dataURL = "<?php echo base_url('eliminar_empleados'); ?>" + "/" + id + "/" + 'A';
      $.ajax({
        type: "POST",
        url: dataURL,
        dataType: "json",
